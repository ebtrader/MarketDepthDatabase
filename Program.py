...
class TestApp(TestWrapper, TestClient):
    ...
    def tickByTickOperations_req(self):
        ...
        self.reqTickByTickData(19003, ContractSamples.SimpleFuture(), "BidAsk", 0, False)
    ...
    def marketDepthOperations_req(self):
        ...
        #self.updateMktDepthL2(2002, ContractSamples.EurGbpFx(), 5, False, [])
    ...
    def marketScannersOperations_req(self):
        ...
        self.reqScannerSubscription(7003,
        ScannerSubscriptionSamples.ComplexOrdersAndTrades(), [], AAPLConIDTag) # requires TWS v975+
