...
class DBHelper(EWrapper, EClient):
    ...
    def getDBConnection(self):
        ...
        try:
            connection = mysql.connector.connect(host='mysql.dev.cheapcooking.store',
                                                 database='cheapcooking_db',
                                                 user='ebtrader',
                                                 password='Suite203!'
                                                 )
    ...
    def insertData(self, values):
        ...
        try:
            ...
            mySql_insert_query = """INSERT INTO updatemarketdepth (ReqId, POSITION, Operation, Side, Price, SIZE) 
                                   VALUES (%s, %s, %s, %s, %s, %s) """
